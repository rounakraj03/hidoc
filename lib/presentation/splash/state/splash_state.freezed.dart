...
class _$_SplashState implements _SplashState {
  const _$_SplashState({this.logo, this.deviceRootedMessage = ""});
  ...
  @override
  String toString() {
    return 'SplashState(logo: $logo, deviceRootedMessage: $deviceRootedMessage)';
  }
...
abstract class _SplashState implements SplashState {
  const factory _SplashState(
      {final Image? logo, final dynamic deviceRootedMessage}) = _$_SplashState;
