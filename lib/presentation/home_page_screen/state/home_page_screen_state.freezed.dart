...
part of 'home_page_screen_state.dart';
...
mixin _$HomePageScreenState {
  ...
  @JsonKey(ignore: true)
  $HomePageScreenStateCopyWith<HomePageScreenState> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $HomePageScreenStateCopyWith<$Res> {
  factory $HomePageScreenStateCopyWith(
          HomePageScreenState value, $Res Function(HomePageScreenState) then) =
      _$HomePageScreenStateCopyWithImpl<$Res, HomePageScreenState>;
  @useResult
  $Res call(
      {List<dynamic> news,
...
/// @nodoc
class _$HomePageScreenStateCopyWithImpl<$Res, $Val extends HomePageScreenState>
    implements $HomePageScreenStateCopyWith<$Res> {
  _$HomePageScreenStateCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$_HomePageScreenStateCopyWith<$Res>
    implements $HomePageScreenStateCopyWith<$Res> {
  factory _$$_HomePageScreenStateCopyWith(_$_HomePageScreenState value,
          $Res Function(_$_HomePageScreenState) then) =
      __$$_HomePageScreenStateCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {List<dynamic> news,
...
/// @nodoc
class __$$_HomePageScreenStateCopyWithImpl<$Res>
    extends _$HomePageScreenStateCopyWithImpl<$Res, _$_HomePageScreenState>
    implements _$$_HomePageScreenStateCopyWith<$Res> {
  __$$_HomePageScreenStateCopyWithImpl(_$_HomePageScreenState _value,
      $Res Function(_$_HomePageScreenState) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_HomePageScreenState(
      news: null == news
          ? _value._news
          : news // ignore: cast_nullable_to_non_nullable
              as List<dynamic>,
...
class _$_HomePageScreenState implements _HomePageScreenState {
  const _$_HomePageScreenState(
  ...
  @override
  String toString() {
    return 'HomePageScreenState(news: $news, trandingBulletin: $trandingBulletin, specialityName: $specialityName, latestArticle: $latestArticle, exploreArticle: $exploreArticle, trandingArticle: $trandingArticle, article: $article, selectedArticle: $selectedArticle, bulletin: $bulletin, sID: $sID, defaultState: $defaultState)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_HomePageScreenState &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_HomePageScreenStateCopyWith<_$_HomePageScreenState> get copyWith =>
      __$$_HomePageScreenStateCopyWithImpl<_$_HomePageScreenState>(
          this, _$identity);
}

abstract class _HomePageScreenState implements HomePageScreenState {
  const factory _HomePageScreenState(
      ...
      final int sID,
      final int defaultState}) = _$_HomePageScreenState;
